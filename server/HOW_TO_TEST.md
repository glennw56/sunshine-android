...
**Sideload APK (v0.1.76-debug):** export Godot 4.3 Android debug (`versionCode` 77), or after cut:
https://github.com/glennw56/sunshine-android/releases/download/v0.1.76-debug/sunshines-bakery-0.1.76-debug.apk

**Previous sideload (v0.1.75-debug):**
