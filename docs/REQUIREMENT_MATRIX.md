...
| I1 | Staging deploy + APK | Infra | A1,O1 | Installable debug APK | 0.1.76: Godot 4.3 Android debug export (`versionCode` 77). 0.1.74: https://github.com/glennw56/sunshine-android/releases/download/v0.1.74-debug/sunshines-bakery-0.1.74-debug.apk | review (export on machine with SDK) |
