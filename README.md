...
This is a **cute third-person patio** (rounded people, real 2231 lawn menu photo) with CC0 textures (see `assets/foss/NOTICE.md`), not a photoreal remake. 0.1.60 keeps patio chat in a compact top-left overlay so the left walking stick stays fully usable. Patio origin stays `https://sunshine-explore-k6uuoen7wa-ue.a.run.app`. See `docs/ROOM_SERVER.md`.
...
0.1.60 keeps patio chat in a compact top-left overlay (name + text, tiny Mute/Block/Report) so the left walking stick stays fully usable. Patio origin stays `https://sunshine-explore-k6uuoen7wa-ue.a.run.app` (cap 16, min 0 / max 1). See `docs/ROOM_SERVER.md` and `docs/TWO_PHONE_PATIO.md`.
