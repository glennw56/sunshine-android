...
Storefront photographs were **not** committed. 3D scenery is procedural low-poly approximating the Irondale shop (front tables, back porch, 1st Ave + tracks). See `docs/ASSETS.md` for swapping in later ≤1-year photos.
