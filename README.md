...
This is a **cute third-person patio** (rounded people, real 2231 lawn menu photo) with CC0 textures (see `assets/foss/NOTICE.md`), not a photoreal remake. 0.1.57 replaces the leftover faceted beanbags with rounded poufs, adds south-bistro umbrellas, and offers Mute/Block/Report after patio chat. Toss cookie still leaves the hand. Patio origin stays `https://sunshine-explore-k6uuoen7wa-ue.a.run.app`. See `docs/ROOM_SERVER.md`.
...
0.1.57 hides the leftover faceted beanbags and plants rounded poufs plus south-bistro umbrellas. After a remote chat line you can Mute, Block, or Report. Toss cookie still leaves the hand. Patio origin stays `https://sunshine-explore-k6uuoen7wa-ue.a.run.app` (cap 16, min 0 / max 1). See `docs/ROOM_SERVER.md` and `docs/TWO_PHONE_PATIO.md`.
